...
[State -1, Down  C]
type = ChangeState
value = cond(pos Y < 0 ,1424,1403)
triggerall = command = "holddown"
triggerall = command = "c"
trigger1 = ctrl
trigger2 = numhelper(700) > 0
triggerall = stateno != 1424 || stateno != 450
...
[State -1, Skill Special]
type = ChangeState
Triggerall = power >= 500
value = 430;cond(pos Y < 0,430,1403)
...
type = ChangeState
value = cond(pos Y < 0,487,490)
Triggerall = power >= 300
triggerall = command = "holdfwd"
triggerall = command = "c"
trigger1 = ctrl
triggerall = stateno != [487,493]
trigger2 = numhelper(700) > 0

[State -1, Neutral Special]
type = ChangeState
Triggerall = power >= 300
value = cond(pos Y < 0, 480,400)
triggerall = command != "holdup"
triggerall = command != "holdback"
triggerall = command != "holddown"
triggerall = command != "holdfwd"
